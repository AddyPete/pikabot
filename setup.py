...
data_files.append(('share/' + package_name + '/worlds/PIKABOT/models', ['worlds/PIKABOT/models/pika.obj']))
data_files.append(('share/' + package_name + '/worlds/PIKABOT/models', ['worlds/PIKABOT/models/pika.mtl']))
