...
data_files.append(
    (
        ...
        ["worlds/PIKABOT/worlds/pikabot.wbt"],
    )
)
data_files.append(
    (
        "share/" + package_name + "/worlds/PIKABOT/models",
        ["worlds/PIKABOT/models/pika.obj"],
    )
)
data_files.append(
    (
        "share/" + package_name + "/worlds/PIKABOT/models",
        ["worlds/PIKABOT/models/pika.mtl"],
    )
)
...
data_files.append(
    ("share/" + package_name + "/resource", ["resource/pikabot_model.xacro"])
)
